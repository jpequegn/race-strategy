...
<gpx version="1.1" creator="Test">
  <trk>
    ...
    def test_parse_invalid_gpx(self):
        ...
        try:
            with pytest.raises(ValueError):  # Could be "No tracks found" or "Invalid GPX file format"
...
<gpx version="1.1" creator="Test">
    ...
    def test_climb_detection(self):
        ...
        gps_points = [
            ...
            GPSPoint(40.0050, -74.0000, 185.0, 1.0, -1.0),  # End climb with descent (total 0.8 miles)
        ]
