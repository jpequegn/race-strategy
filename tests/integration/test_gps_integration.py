  ...
  <trk>
    ...
    def test_full_gps_to_strategy_pipeline(self):
        ...
        try:
            ...
            with patch.object(RaceStrategyPipeline, 'generate_strategy') as mock_generate:
            ...
            with patch('src.pipelines.core_strategy.RaceStrategyPipeline'):
                ...
                if course.key_climbs:
                    for climb in course.key_climbs:
                        assert climb.name in formatted_data or str(climb.start_mile) in formatted_data
    ...
    def create_mock_strategy(self):
        ...
        class MockStrategy:
            ...
            key_success_factors = "Execute GPS-based climb strategy, handle technical descents"
        return MockStrategy()
